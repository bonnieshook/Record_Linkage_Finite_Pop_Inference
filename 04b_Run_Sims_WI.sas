...
proc means data=mockdatab sum; var sqrt_ICR; run;


%let ctrl_tot=100 80 20 142.7180089;

%include "&path.\04a_Include_WI.sas";
...
%let ctrl_tot=200 160 40 285.6968696;
...
%let ctrl_tot=500 400 100 841.2260057;
